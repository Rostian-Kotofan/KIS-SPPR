                              ...
                              <button
                                ...
                                className={`w-6 h-6 rounded-full flex items-center justify-center font-mono text-[9px] font-bold border ${
                                  mr.id === selectedRisk.id
                                    ? "bg-slate-950 text-white ring-2 ring-blue-500 border-blue-400 animate-pulse"
          ...
          {selectedRisk && (
            <div className="bg-white rounded-xl border border-slate-100 p-5 shadow-xs space-y-4">
              <div className="flex justify-between items-start pb-2 border-b border-slate-100">
                <div>
                  <span className="text-[10px] text-blue-600 font-bold uppercase tracking-wider">{selectedRisk.category}</span>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="space-y-2 p-3 bg-slate-50 rounded-lg">
                  <div className="flex justify-between text-xs font-semibold text-slate-700">
                    ...
                    <span className="font-mono text-blue-600">{selectedRisk.probability} / 5</span>
                  </div>
                  <input
                    type="range"
                    min="1"
                ...
                <div className="space-y-2 p-3 bg-slate-50 rounded-lg">
                  <div className="flex justify-between text-xs font-semibold text-slate-700">
                    ...
                    <span className="font-mono text-blue-600">{selectedRisk.impact} / 5</span>
                  </div>
                  <input
                    type="range"
                    min="1"
